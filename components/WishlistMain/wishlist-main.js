          ...
          <div className={s.cardlist}>
            <div className={s.row}>
              {wishlistItems.map((product) => {
                ...
                return (
                  <div className={s.wrapper} key={product.id}>
                    <div className={s.card}>
                      <div className={s.top}>
                        <Image width={350} height={350} src={product.image.sourceUrl} alt="" className={s.img} />
                        <Link href={`/product/${product.slug}`}>
                          <a className={s.productLink}>Перейти в товар</a>
                        </Link>
                      ...
                      <div className={s.details}>
                        <div className={s.nameRemove}>
                          <div className={s.brand}>
                            {product.variations?.nodes[0].name
                              ? product.variations.nodes[0].name
                              : null}
                          </div>
